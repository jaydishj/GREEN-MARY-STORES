...
<!-- Header Section -->
<header>
    <img src= "https://upload.wikimedia.org/wikipedia/commons/thumb/4/4e/Our_Lady_of_Sorrows%2C_by_Juan_de_Ju%C3%AD%2C_1571.jpg/800px-Our_Lady_of_Sorrows%2C_by_Juan_de_Ju%C3%AD%2C_1571.jpg" alt="Our Lady of Fatima" class="logo">
    <h1>SMC STORE</h1>
    ...
    if not st.session_state.admin_logged:
        ...
        if not orders:
            ...
            for i, order in enumerate(orders):
                ...
                if screenshot_path != "N/A" and os.path.exists(f"screenshots/{screenshot_path}"):
                    with open(f"screenshots/{screenshot_path}", "rb") as f:
                        img_bytes = f.read()
                        st.download_button(
